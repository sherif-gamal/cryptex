...
describe('cryptex MainSection component', () => {
  ...
  describe('toggle all input', () => {
    ...
    it('should be checked if all watchlist completed', () => {
      const { output } = setup({
        watchlist: [{
          text: 'Use Redux',
          completed: true,
  ...
  describe('footer', () => {
    ...
    it('onClearCompleted shouldnt call clearCompleted if no watchlist completed', () => {
      const { output, props } = setup({
        watchlist: [{
          text: 'Use Redux',
          completed: false,
  ...
  describe('todo list', () => {
    it('should render', () => {
      ...
      list.props.children.forEach((item, index) => {
        ...
        expect(item.props.todo).to.equal(props.watchlist[index]);
      });
    });
    ...
    it('should filter items', () => {
      ...
      expect(updatedList.props.children[0].props.todo).to.equal(props.watchlist[1]);
    });
  });
});
